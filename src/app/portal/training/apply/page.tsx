...
import { GraduationCap, Clock, Users, ArrowLeft, Calendar } from "lucide-react";
              ...
              <CardContent>
                ...
                <div className="space-y-2 text-sm text-gray-500 mb-4">
                  ...
                  {course.maxCapacity && (
                    <div className="flex items-center gap-2">
                      <Users className="w-4 h-4" />
                      <span>정원: {course._count.trainings}/{course.maxCapacity}명</span>
                    </div>
                  )}
                </div>
                <Button
                  ...
                  disabled={course.maxCapacity !== null && course._count.trainings >= course.maxCapacity}
                >
                  {course.maxCapacity !== null && course._count.trainings >= course.maxCapacity
                    ? "마감"
                    : "신청하기"}
                </Button>
              </CardContent>
